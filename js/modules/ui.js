...
function getTimeSuggestions(distance) {
    ...
    if (distance === 100) {
        ...
        suggestions.push('10:00', '11:00', '12:00', '13:00', '14:00', '15:00', '16:00', '17:00', '18:00', '19:00');
    }
        ...
        suggestions.push('20:00', '22:00', '24:00', '26:00', '28:00', '30:00', '32:00', '34:00', '36:00', '40:00');
    }
    else if (distance >= 8040 && distance <= 8050) {
        suggestions.push('28:00', '29:00', '30:00', '31:00', '32:00', '33:00', '34:00', '35:00', '36:00', '37:00');
    }
    else if (distance === 10000) {
        suggestions.push('40:00', '45:00', '50:00', '55:00', '1:00:00', '1:05:00', '1:10:00', '1:15:00', '1:20:00', '1:25:00');
    }
    else if (distance >= 16080 && distance <= 16100) {
        suggestions.push('60:00', '65:00', '70:00', '75:00', '80:00', '85:00', '90:00', '95:00', '1:40:00', '1:50:00');
    }
    else if (distance >= 21090 && distance <= 21100) {
        suggestions.push('1:30:00', '1:40:00', '1:50:00', '2:00:00', '2:10:00', '2:20:00', '2:30:00', '2:40:00', '2:50:00', '3:00:00');
    }
    else if (distance >= 42190 && distance <= 42200) {
        suggestions.push('3:00:00', '3:30:00', '4:00:00', '4:30:00', '5:00:00', '5:30:00', '6:00:00', '6:30:00', '7:00:00', '7:30:00');
    }
    else if (distance === 60000) {
        suggestions.push('5:00:00', '6:00:00', '7:00:00', '8:00:00', '9:00:00', '10:00:00', '11:00:00', '12:00:00', '13:00:00', '14:00:00');
    }
    else if (distance === 100000) {
        suggestions.push('8:00:00', '10:00:00', '12:00:00', '14:00:00', '16:00:00', '18:00:00', '20:00:00', '22:00:00', '24:00:00', '26:00:00');
    }
